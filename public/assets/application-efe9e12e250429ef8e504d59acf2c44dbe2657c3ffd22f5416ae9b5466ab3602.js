...
(function() {
  var USER_MARKER_OPTIONS, USER_MARKER_RADIUS, UserLocation, auto_move_to_user_position, centerOnUserLocation, created_maps, map_factory, user_location;
  ...
  UserLocation = (function() {
    ...
    UserLocation.prototype.updateMarker = function() {
      if (this.addedToMap) {
        return this.marker.setLatLng([this.lat, this.lon]);
      } else {
        this.marker = L.circle([this.lat, this.lon], USER_MARKER_RADIUS, USER_MARKER_OPTIONS);
        return this.marker.addTo(L.map('map'));
      }
    };
  ...
  if ('geolocation' in navigator) {
    navigator.geolocation.watchPosition(function(position) {
      ...
      if (auto_move_to_user_position) {
        ...
        return auto_move_to_user_position = false;
      }
    }, function(error) {
